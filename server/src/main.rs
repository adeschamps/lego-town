...
// protobufs must be included differently depending on whether they are in the
// src directory or generated by the build.
// I imagine this could be cleaner.
#[cfg(feature="protoubuf_generate")]
include!(concat!(env!("OUT_DIR"), "/messages.rs"));
#[cfg(not(feature="protoubuf_generate"))]
mod messages;
